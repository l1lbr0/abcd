...
const CustomerAdded = () => {
  ...
  const initialData = {
    ...
    datasets: [
      {
        label: 'Customers',
        data: [2,5,1,4,7], // Replace with your actual data
        backgroundColor: [
          'rgba(255, 99, 132, 0.6)',
          'rgba(54, 162, 235, 0.6)',
          'rgba(255, 206, 86, 0.6)',
      ...
      datasets: [
        {
          ...
          data: [6,3,5,2,1], // Replace with next 5 years data
        },
      ],
    }));
    ...
    if (currentStartYear > 1) {
      setCurrentData(prevData => ({
        ...
        datasets: [
          {
            ...initialData.datasets[0],
            data: [2,5,1,4,7], // Replace with previous 5 years data
          },
        ],
      }));
      setCurrentStartYear(currentStartYear - 5); // Update starting year
